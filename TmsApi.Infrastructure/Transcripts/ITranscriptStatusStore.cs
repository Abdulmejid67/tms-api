...
public interface ITranscriptStatusStore
{
    ...
    Task<string?> GetReportIdForIdempotencyKeyAsync(string key, CancellationToken ct);
    Task LinkIdempotencyKeyAsync(string key, string reportId, CancellationToken ct);
}